...
<body>
    <page size="A4">
        ...
        <table width="100%">
            <tbody><tr>
                <td align="center" style="font-size:14px;font-weight:bold;">Laporan Surat Keluar</td>
            </tr>
            <tr>
            	<td>
    	...
    	<table id="khs_table" class="table table-bordered gridtable" style="font-size:11px;margin-top:15px" border="1">
	        <thead bgcolor="#fff">
	          <tr>
	            ...
	            <th style="width:20%;" class="hidden-xs">Alamat Penerima</th>

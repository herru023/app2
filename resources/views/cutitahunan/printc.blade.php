...
<body>
    <page size="A4">
        ...
        <table width="100%">
            <tbody><tr>
                <td align="center" style="font-size:14px;font-weight:bold;">Laporan Cuti Tahunan</td>
            </tr>
            <tr>
            	<td>
    	...
    	<table id="khs_table" class="table table-bordered gridtable" style="font-size:11px;margin-top:15px" border="1">
	        <thead bgcolor="#fff">
	          <tr>
	            ...
	            <th style="width:20%;" class="hidden-xs">Nama</th>
	            <th style="width:20%;">nip</th>
	            <th style="width:10%;">Pangkat</th>
	            <th style="width:10%;">Jabatan</th>
	            <th style="width:10%;">Unit Kerja</th>
	            <th style="width:5%;">Lamanya</th>	            
	            <th style="width:15%;">Di Jalankn di</th>
	            <th style="width:15%;">Tgl Mulai</th>
	            <th style="width:15%;">Sampai Tgl</th>
